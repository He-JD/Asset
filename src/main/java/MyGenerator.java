...
public class MyGenerator {
     ...
     * 模块名称
     */
    private static final String MODULE_NAME = "xgq";
    /**
     * 输出文件的路径
     */
    private static final String OUT_PATH = "D:\\develop";
    /**
     * 代码生成者
     */
    private static final String AUTHOR = "HeJD";

    /**
     * JDBC相关配置
     */
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private static final String URL = "jdbc:mysql://:3306/test?useUnicode=true&characterEncoding=UTF-8";
                ...
                new DataSourceConfig().setDbType(DbType.MYSQL)// 数据库类型
                        ...
                        new StrategyConfig()
                                ...
                                .setNaming(NamingStrategy.underline_to_camel)// 表名生成策略
                                 //.setInclude(new String[] {"sys_log"}) // 需要生成的表
                                // .setExclude(new String[]{"test"}) // 排除生成的表
                                // 自定义实体，公共字段
                                 .setSuperEntityColumns(new String[]{"create_date","create_by","update_date","update_by","remarks","del_flag"})
                                .setTableFillList(tableFillList)
                                // 自定义实体父类
                                 .setSuperEntityClass("com.xgq.common.DataEntity")
                                // // 自定义 mapper 父类
