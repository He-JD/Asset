...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-footer footer">
        <p>Copyright © 2018甜蜜味哇哈哈  Design By 马哥 <a href="http://www.miibeian.gov.cn" target="_blank">苏ICP备17063650号 </a></p>
    </div>
</div>
<script>
    var baseUrl = "${base}";
