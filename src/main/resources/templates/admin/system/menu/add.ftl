...
<form class="layui-form"   action="${base}/admin/system/menu" method="post" style="width:80%;">
    <#if parentMenu != null>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="href" lay-verify="required"  placeholder="请输入菜单地址">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">菜单权限</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="permission" lay-verify="required" placeholder="菜单权限">
        </div>
    </div>
    <div class="layui-form-item">
